...
import { CreditCard, Bitcoin, Lock, Mail, Link as LinkIcon } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";

// Página de demo para screenshot del checkout con Bitcoin
const CheckoutDemoBitcoin = () => {
  // Mock data
  const mockItems = [
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Payment Method Selection - Bitcoin Selected */}
          <div className="space-y-3">
            <Label>Método de Pago</Label>
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="p-4 rounded-xl border-2 border-border hover:border-primary/50 transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                type="button"
                className="p-4 rounded-xl border-2 border-primary bg-primary/10 transition-all flex items-center justify-center gap-2"
              >
...
export default CheckoutDemoBitcoin;
